...
const BoothArtboard = () => (
  <div className="flex flex-col h-[470px] w-1/4 p-7 bg-brand-beige2 border border-brand-gray2 shadow-[-20px_15px_0px_0px_rgba(30,30,30)]">
    <div className="grow"> Content</div>
    <div className="flex flex-col h-24">
      <h1 className="font-extrabold mb-4">Canvas ID 1</h1>
