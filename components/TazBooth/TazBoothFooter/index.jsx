...
const TazBoothFooter = () => (
  <div className="flex justify-between h-1/3 px-20 items-center bg-brand-black text-brand-beige">
    ...
    <div className="text-brand-beige px-20">
      ...
      <p className="text-lg">
        People are anonymously contributing to 4 active canvases above 👆 Check out the gallery of completed canvases in
        the app.
      </p>
    </div>
    ...
    <div className="text-brand-beige px-20">
      ...
      <p className="text-lg">
        Generate a Semaphore identity so that you can collaborate anonymously. Your ID comes with 1 chance to vote for
