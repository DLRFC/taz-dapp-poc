        ...
        <div className="index-[10] relative divide-y overflow-y-auto rounded-md border-2 border-gray-500 bg-brand-beige drop-shadow-lg">
          ...
          <div className="flex items-center justify-center">
            <div>
              ...
              >
                <div
                  className={`w-4 h-4 bg-${c} rounded-full mr-5 mb-5 mr-2 cursor-pointer`}
                  id={`text-${c}`}
                ></div>
              </button>
            ))} */}
              ...
              >
                <div
                  className="w-4 h-4 bg-red-600 rounded-full mr-5 mb-5 mr-2 cursor-pointer"
                  id="text-red-600"
                ></div>
              </button>
              <button
              ...
              >
                <div
                  className="w-4 h-4 bg-orange-500 rounded-full mr-5 mb-5 mr-2 cursor-pointer"
                  id="text-orange-500"
                ></div>
              </button>
              <button
              ...
              >
                <div
                  className="w-4 h-4 bg-yellow-300 rounded-full mr-5 mb-5 mr-2 cursor-pointer"
                  id="text-yellow-300"
                ></div>
              </button>
              <button
              ...
              >
                <div
                  className="w-4 h-4 bg-green-600 rounded-full mr-5 mb-5 mr-2 cursor-pointer"
                  id="text-green-600"
                ></div>
              </button>
              <button
              ...
              >
                <div
                  className="w-4 h-4 bg-blue-600 rounded-full mr-5 mb-5 mr-2 cursor-pointer"
                  id="text-blue-600"
                ></div>
              </button>
              <button
              ...
              >
                <div
                  className="w-4 h-4 bg-purple-600 rounded-full mr-5 mb-5 mr-2 cursor-pointer"
                  id="text-purple-600"
                ></div>
              </button>
            </div>
