    ...
    <div className="grid mb-20">
      ...
      <div className="col-start-1 row-start-1 px-6 py-8">
        <Link href="/experiences-page">
          <div className="flex max-w-[76px] max-h-[32px] bg-black ml-3 mb-12 px-1 text-xl text-brand-beige2 cursor-pointer shadow-[2.0px_3.0px_3.0px_rgba(0,0,0,0.38)]">
            <BackTAZ />
            <h1>TAZ</h1>
          </div>
        </Link>
        ...
        <div>
          <h3 className="relative inline-block ml-3 mb-4 text-lg text-brand-blue tracking-wide">
            makes this anonymous
          </h3>
        </div>
