...
export default function GenerativeArt() {
    ...
    return (
            <div className="flex items-center justify-center flex-col gap-y-5 mt-10">
                ...
                <button className="bg-blue-300 text-gray-700 font-bold p-5 mt-3 rounded-2xl" onClick={handleGenerateProof}>Generate Proof</button>
                <h1>Proof</h1>
                <h1>Address</h1>
                <input className="bg-gray-200"></input>
                <button className="bg-blue-300 text-gray-700 font-bold p-5 mt-3 rounded-2xl">Submit</button>
                <h1>Submited</h1>
                <button className="bg-blue-300 text-gray-700 font-bold p-5 mt-3 rounded-2xl">Mint Nft</button>
                <h1>Minted!</h1>
